...
import javax.swing.*;
public class FixedDebugEleven4
{
   static FixedDebugBoat[] boatArray = new FixedDebugBoat[5];
   ...
   public static void buildArray()
   {
      ...
      for(int x = 0; x < boatArray.length; ++x)
      {
         ...
         if(boatType =='r')
            ...
            boatArray[x] = new FixedDebugRowboat();
         else
            boatArray[x] = new FixedDebugOceanLiner();
      }
   }
